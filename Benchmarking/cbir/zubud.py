        ...
        try:
            ...
            for file in config_main.BENCHMARK_SAMPLE_NAMES:
                ...
                try:
                    ...
                    log_error_to_console("BENCHMARK CBIR mAP: {file}".format(file=file), ex.__str__())

            log_benchmark_info_to_console('CBIR ZuBuD Top1: {:<10s} {:<10.6f}\n'.format(set, (Top1 / count) * 100))
